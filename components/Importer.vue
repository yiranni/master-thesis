<template>
  <div class="main">
    <svg ref="importCountry" />
  </div>
</template>

<script>
import AnimalTrade from "~/assets/data/AcinonyxTopImporter.json";
...
export default {
  ...
  methods: {
    createBarChart() {
      ...
      const barChartContainer = this.$refs.importCountry;
